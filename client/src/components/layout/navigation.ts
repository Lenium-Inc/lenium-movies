import { Clapperboard, Compass, Film, Home as HomeIcon, Library, List, Sparkles } from "lucide-react";

/**
 * Available catalog views. `home` maps to the landing page and every other
 * value maps to a filtered shelf view.
 */
export type View = "home" | "movies" | "new" | "popular" | "genres" | "collections" | "my-list";
