...
/**
 * Cinematic 404 page: a dark, theatrical zinc-950 canvas with violet
 * atmospheric glow, a faint full-screen grid, a glitching CRT television,
 * and branded CTAs.
 */
export default function NotFound() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-zinc-950 text-white">
      {/* Violet atmospheric glows */}
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 left-1/2 h-[38rem] w-[70rem] -translate-x-1/2 rounded-full bg-[radial-gradient(closest-side,rgba(124,58,237,0.18),transparent)] blur-3xl"
      />
      <div
        aria-hidden
      ...
      {/* Faint full-screen violet grid, faded toward the edges */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.06)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.06)_1px,transparent_1px)] bg-[size:44px_44px] [mask-image:radial-gradient(ellipse_70%_60%_at_50%_40%,black,transparent)]"
      />
      ...
      <div className="relative z-10 w-full max-w-2xl px-6 py-16 text-center">
        <div className="flex flex-col items-center space-y-8">
            ...
            >
              ...
              <g clipPath="url(#notfound-screen)">
                ...
                <g className="animate-pulse">
                  <rect x="64" y="76" width="192" height="6" fill="rgba(139,92,246,0.35)" />
                  <rect x="64" y="98" width="192" height="3" fill="rgba(255,255,255,0.18)" />
                  <rect x="64" y="122" width="192" height="5" fill="rgba(139,92,246,0.22)" />
          ...
          <p className="mx-auto max-w-md text-sm leading-6 text-zinc-400 md:text-base">
          ...
          <div id="not-found-button-group" className="flex flex-col justify-center gap-3 sm:flex-row">
            <button
              type="button"
              onClick={() => goTo("/")}
              className="inline-flex items-center justify-center gap-2 rounded-md bg-violet-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-400"
            >
